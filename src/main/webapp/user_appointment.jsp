<%@page import="com.mafs.entity.Doctor"%>
<%@page import="com.mafs.db.DBConnection"%>
<%@page import="com.mafs.dao.DoctorDAO"%>
					...
					<div class="card-body">
						...
						<form class="row g-3" action="addAppointment" method="post">
							...
							<div class="col-md-6">
								...
								required="required"	name="appointmentDate" id="myDate" type="date" class="form-control">
							</div>
							...
							<div class="col-md-6">
								<label class="form-label">Reason For Visit</label> <input
								required="required"	name="diseases" type="text" placeholder="Enter Reason to visit"
									class="form-control">
							</div>
...
<script>
  ...
  document.addEventListener("DOMContentLoaded", function() {
              ...
              myDate.setAttribute("min", new Date().toISOString().substring(0, 10));
              myDate.setAttribute("max", getFiveDaysFromNow());
          });
</script>
</body>
</html>